        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">
              We specialize in providing inbound and outbound call center services 
              that help businesses boost customer satisfaction, increase sales, 
              and maintain strong client relationships through professional communication.
            </p>
          </motion.div>
