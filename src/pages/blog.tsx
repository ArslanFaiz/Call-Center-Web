        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">
              Insights & Strategies for Smarter Communication
            </h3>
            <p className="text-gray-600 text-lg">
              Stay updated with the latest trends, success stories, and 
              expert insights from the world of customer service and call centers. 
              Discover how technology and strategy can transform the way you connect with clients.
            </p>
          </motion.div>
